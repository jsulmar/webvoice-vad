...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=s(require("./node.js")),e=s(require("./error.js"));function s(t){return t&&t.__esModule?t:{default:t}}function o(t,e){var s=Object.keys(t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(t);e&&(o=o.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),s.push.apply(s,o)}return s}function r(t){for(var e=1;e<arguments.length;e++){var s=null!=arguments[e]?arguments[e]:{};e%2?o(Object(s),!0).forEach(function(e){i(t,e,s[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(s)):o(Object(s)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(s,e))})}return t}function i(t,e,s){return e in t?Object.defineProperty(t,e,{value:s,enumerable:!0,configurable:!0,writable:!0}):t[e]=s,t}class n extends t.default{constructor(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};super(),this.options=r(r({},n.defaultOptions),t),this.hookableOnNodeTypes=[],this.type="mic",this.event="srcFrame",this.hookedOn=null}async start(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(null==this||!this.hookedOn){if(console.log("Src start:",this.hookedOn),this.options=r(r({},this.options),t),this.hookedOn)throw new e.default("Source is already started, call stop() first");const{stream:s,context:o,node:i}=this.options.source;this.stream=s||await navigator.mediaDevices.getUserMedia({audio:this.options.constraints,video:!1}),this.context=s&&o?o:new(window.AudioContext||window.webkitAudioContext),this.mediaStreamSource=s&&o&&i?i:this.context.createMediaStreamSource(this.stream),this.hookedOn=!0,this.sampleRate=this.context.sampleRate,this.scriptProcessor=this.context.createScriptProcessor(this.frameSize,1,1),"non-emitting"==this.status&&this.hookedOn&&(this.scriptProcessor.onaudioprocess=(t=>{const e=t.inputBuffer.getChannelData(0);this.dispatchEvent(new CustomEvent(this.event,{detail:e})),this.options.onAudioFrame(e)}),this.mediaStreamSource.connect(this.scriptProcessor),this.scriptProcessor.connect(this.context.destination),this.status="emitting")}return Promise.resolve()}resume(){super.resume(),this.mediaStreamSource.connect(this.scriptProcessor),this.scriptProcessor.connect(this.context.destination)}pause(){super.pause(),this.mediaStreamSource.disconnect(),this.scriptProcessor.disconnect()}stop(){this.hookedOn&&(this.stream.getTracks().map(t=>"live"===t.readyState&&"audio"===t.kind&&t.stop()),this.pause(),delete this.mediaStreamSource,delete this.scriptProcessor,this.context.close().then(()=>{delete this.stream,delete this.context}),this.hookedOn=null)}}exports.default=n,i(n,"defaultOptions",{source:{stream:null,context:null,node:null},onAudioFrame:()=>{},frameSize:4096,constraints:{echoCancellation:!0,autoGainControl:!0,noiseSuppression:!0,channelCount:1}});
