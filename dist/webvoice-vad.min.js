...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=i(require("../nodes/node.js")),e=require("../rnnoise/index.js");function i(t){return t&&t.__esModule?t:{default:t}}function s(t,e,i){return e in t?Object.defineProperty(t,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[e]=i,t}let n=0,o=0,h=0;const r=function(t){const i=t.detail,s=[...this.bufferResidue,...i];let r=0;for(;r+e.RNNOISE_SAMPLE_LENGTH<s.length;r+=e.RNNOISE_SAMPLE_LENGTH){const t=s.slice(r,r+e.RNNOISE_SAMPLE_LENGTH),i=this.wasmRuntime.calculateAudioFrameVAD(t);this.activations.length==this.options.numActivations&&this.activations.shift(),this.activations.push(0+(i>this.options.threshold)),!(n++%10)&&console.log("vadScore:",i.toFixed(3));let a=this.activations.reduce((t,e)=>t+e);i>=this.options.threshold&&this.redemptionTimer&&(clearTimeout(this.redemptionTimer),this.redemptionTimer=!1),i<this.options.threshold&&!this.redemptionTimer&&this.speaking&&(this.redemptionTimer=setTimeout(()=>{this.wasmRuntime&&(this.speaking=!1,h=new Date,console.log("------------\x3e dispatch false (".concat(h-o,")")),o=h,this.dispatchEvent(new CustomEvent(this.event,{detail:!1})))},this.options.timeAfterStop)),a>=this.options.numActivations&&!this.speaking&&(this.speaking=!0,h=new Date,console.log("------------\x3e dispatch true (".concat(h-o,")")),o=h,this.dispatchEvent(new CustomEvent(this.event,{detail:!0})))}this.bufferResidue=s.slice(r,s.length)};class a extends t.default{constructor(){let{numActivations:t=10,threshold:e=.85,timeAfterStop:i=800}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};super(),this.handler=r.bind(this),this.type="vad",this.event="speakingStatus",this.hookableOnNodeTypes=["mic","downSampler","speechPreemphaser"],this.options={numActivations:t,threshold:e,timeAfterStop:i}}start(t){this.wasmRuntime=new e.Rnnoise,this.bufferResidue=new Float32Array([]),this.redemptionTimer=!1,this.activations=[],this.speaking=!1,super.start(t)}stop(){this.hookedOn&&(super.stop(),this.wasmRuntime.destroy(),delete this.wasmRuntime)}}exports.default=a,s(a,"defaultOptions",{numActivations:10,threshold:.85,timeAfterStop:800});
