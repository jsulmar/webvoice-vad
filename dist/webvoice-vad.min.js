...
},{"../nodes/error.js":"KgAV"}],"F24j":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=i(require("../nodes/node.js")),t=i(require("../nodes/error.js"));function i(e){return e&&e.__esModule?e:{default:e}}function o(e,t){var i=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);t&&(o=o.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),i.push.apply(i,o)}return i}function r(e){for(var t=1;t<arguments.length;t++){var i=null!=arguments[t]?arguments[t]:{};t%2?o(Object(i),!0).forEach(function(t){n(e,t,i[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(i)):o(Object(i)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(i,t))})}return e}function n(e,t,i){return t in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}class s extends e.default{constructor(){let{frameSize:e=4096,constraints:t={echoCancellation:!0,autoGainControl:!0,noiseSuppression:!0}}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};super(),this.hookableOnNodeTypes=[],this.type="mic",this.event="micFrame",this.hookedOn=null,this.options={frameSize:e,constraints:t}}async start(){if(this.hookedOn)throw new t.default("Microphone is already started, call stop() first");return this.stream=await navigator.mediaDevices.getUserMedia({audio:r({channelCount:1},this.options.constraints)}),this.hookedOn=!0,this.audioContext=new(window.AudioContext||window.webkitAudioContext),this.options.sampleRate=this.audioContext.sampleRate,this.mediaStreamSource=this.audioContext.createMediaStreamSource(this.stream),this.micFrameGenerator=this.audioContext.createScriptProcessor(this.options.frameSize,1,1),"non-emitting"==this.status&&this.hookedOn&&(this.micFrameGenerator.onaudioprocess=(e=>{const t=e.inputBuffer.getChannelData(0);this.dispatchEvent(new CustomEvent(this.event,{detail:t}))}),this.mediaStreamSource.connect(this.micFrameGenerator),this.micFrameGenerator.connect(this.audioContext.destination),this.status="emitting"),Promise.resolve()}resume(){super.resume(),this.mediaStreamSource.connect(this.micFrameGenerator),this.micFrameGenerator.connect(this.audioContext.destination)}pause(){super.pause(),this.mediaStreamSource.disconnect(),this.micFrameGenerator.disconnect()}stop(){this.hookedOn&&(this.stream.getTracks().map(e=>"live"===e.readyState&&"audio"===e.kind&&e.stop()),this.pause(),delete this.mediaStreamSource,delete this.micFrameGenerator,this.audioContext.close().then(()=>{delete this.stream,delete this.audioContext}),this.hookedOn=null)}}exports.default=s,n(s,"defaultOptions",{frameSize:4096,constraints:{echoCancellation:!0,autoGainControl:!0,noiseSuppression:!0}});
},{"../nodes/node.js":"h6HF","../nodes/error.js":"KgAV"}],"tqbH":[function(require,module,exports) {
...
"use strict";var e=s(require("./webvoicesdk/nodes/mic.js")),d=s(require("./webvoicesdk/nodes/vad.js"));function s(e){return e&&e.__esModule?e:{default:e}}const o={Mic:e.default,Vad:d.default};window.vad=o,module.exports=o;
},{"./webvoicesdk/nodes/mic.js":"F24j","./webvoicesdk/nodes/vad.js":"SsLo"}]},{},["Z7GA"], null)