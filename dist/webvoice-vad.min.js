...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=i(require("../nodes/node.js")),e=require("../rnnoise/index.js");function i(t){return t&&t.__esModule?t:{default:t}}function s(t,e,i){return e in t?Object.defineProperty(t,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[e]=i,t}let o=0,n=0,h=0;const r=t=>{h=new Date,console.log("------------\x3e event ".concat(t," (elapsed ").concat(h-n,")")),n=h},a=function(t){const i=t.detail,s=[...this.bufferResidue,...i];let n=0;for(;n+e.RNNOISE_SAMPLE_LENGTH<s.length;n+=e.RNNOISE_SAMPLE_LENGTH){const t=s.slice(n,n+e.RNNOISE_SAMPLE_LENGTH),i=this.wasmRuntime.calculateAudioFrameVAD(t);this.activations.length==this.options.numActivations&&this.activations.shift(),this.activations.push(0+(i>this.options.threshold)),this.options.dlog&&!(o++%10)&&console.log("vadScore:",i.toFixed(3));let h=this.activations.reduce((t,e)=>t+e);i>=this.options.threshold&&this.redemptionTimer&&(clearTimeout(this.redemptionTimer),this.redemptionTimer=!1),i<this.options.threshold&&!this.redemptionTimer&&this.speaking&&(this.redemptionTimer=setTimeout(()=>{this.wasmRuntime&&(this.speaking=!1,this.options.dlog&&r(this.speaking),this.dispatchEvent(new CustomEvent(this.event,{detail:!1})))},this.options.timeAfterStop)),h>=this.options.numActivations&&!this.speaking&&(this.speaking=!0,this.options.dlog&&r(this.speaking),this.dispatchEvent(new CustomEvent(this.event,{detail:!0})))}this.bufferResidue=s.slice(n,s.length)};class d extends t.default{constructor(){let{numActivations:t=10,threshold:e=.85,timeAfterStop:i=800,dlog:s=!1}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};super(),this.handler=a.bind(this),this.type="vad",this.event="speakingStatus",this.hookableOnNodeTypes=["mic","downSampler","speechPreemphaser"],this.options={numActivations:t,threshold:e,timeAfterStop:i,dlog:s}}start(t){this.wasmRuntime=new e.Rnnoise,this.bufferResidue=new Float32Array([]),this.redemptionTimer=!1,this.activations=[],this.speaking=!1,super.start(t)}stop(){this.hookedOn&&(super.stop(),this.wasmRuntime.destroy(),delete this.wasmRuntime)}}exports.default=d,s(d,"defaultOptions",{numActivations:10,threshold:.85,timeAfterStop:800,dlog:!1});
